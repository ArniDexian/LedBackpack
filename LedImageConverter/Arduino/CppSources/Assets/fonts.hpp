...
// this font containts symbols: ["0-9", "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "A", "S", "D", "F", "G", "H", "J", "K", "L", "Z", "X", "C", "V", "B", "N", "M", ",", ".", "!", "?", "(", ")", ":", "#", "%", "^", "*", "-", "=", "_", "+", "{", "}", "[", "]", ";", "\'", "|", "/", ">", "<", "~"]
// TODO: this should be PROGMEM
const uint8_t font5x5[] = {
    // bit height, bit width, glyphs count
    0x05, 0x05, 0x41,
    //The format is 1 byte ASCII symbol code + 4 bytes per glyph:
    //char '1'
    0x31, 0xC2, 0x10, 0x84, 0x00,
    //char '2'
    0x32, 0xE1, 0x11, 0x0E, 0x00,
    //char '3'
    0x33, 0xE1, 0x10, 0x4E, 0x00,
    //char '4'
    0x34, 0xA5, 0x38, 0x42, 0x00,
    //char '5'
    0x35, 0xE4, 0x38, 0x4E, 0x00,
    //char '6'
    0x36, 0xE4, 0x39, 0x4E, 0x00,
    //char '7'
    0x37, 0xE1, 0x10, 0x84, 0x00,
    //char '8'
    0x38, 0xE5, 0x39, 0x4E, 0x00,
    //char '9'
    0x39, 0xE5, 0x38, 0x4E, 0x00,
    //char '0'
    0x30, 0xE5, 0x29, 0x4E, 0x00,
    //char 'Q'
